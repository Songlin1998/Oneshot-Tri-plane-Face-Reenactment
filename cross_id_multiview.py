...
def main():
    ...
    ckpt = '.../000000.pt'
    target_video_path = '.../train/id11181#cu11S_2dNyA#00001.txt#000.mp4'
    source_video_path ='.../train/id10258#u0qOI6_q5ZY#00011.txt#000.mp4'
    target_idx = 6
    source_idx = 159
    ...
    PIL.Image.fromarray(img[0].cpu().numpy(), 'RGB').save(f'cross_id_multiview_yaw.png')
